...
const projects=[
  {title:"Games-hub" ,description:" A JavaScript-based gaming platform where users can log in, play classic games like Tic-Tac-Toe, Rock Paper Scissors, Whack-a-Mole, and Spin Machine. User scores are tracked and displayed in their profile, with options to update profile details. Admins can manage users, add or remove games, and view high scores.",img:games1,link:"https://github.com/dhackmt/GameWebsite"},
  {title:"Custom-Portfolio-builder" ,description:"A web application where users can log in, fill out a personal information form, and generate resumes using customizable templates. Users can edit their information, adjust font size and color, and regenerate resumes instantly. Includes an admin panel to manage users and their resumes.",img:resume,link:"https://github.com/dhackmt/Custom-Resume-Builder"},
  {title:"Local Tailoring Platform",description:" A community-driven website where local tailors can register by submitting their shop details, specialties, services, images, and reviews. Upon admin approval, shops are showcased on the platform. Users can log in to explore and discover nearby tailor shops, promoting visibility and support for local businesses.",img:tailor,link:"https://github.com/dhackmt/Tailor-website" },
]
    return (
       <div className=" min-h-screen z-0"> 
        <div className="text-white text-3xl md:block hidden text-center relative top-28">My Recent
            ...
            {projects.map((project)=>(
                <Card title={project.title} description={project.description} img={project.img} link={project.link} 
                 />
            ))}
        </div>
       </div>
